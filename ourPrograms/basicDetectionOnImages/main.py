...
""" Testing shit """
for i in range(10):
    TEST_IMAGE_PATHS.append(TEST_IMAGE_PATHS[i])
...
def run_inference_for_multiple_image(images, graph):
    print("Initializing Detection Session")
    with graph.as_default():
        with tf.Session() as sess:
            ...
            for index,image in enumerate(images):
                ...
                # This is just a pretty loading bar thingy
                print("Detection: ", end="")
...
for image_path in TEST_IMAGE_PATHS:
    ...
    detect_images.append(image_np)

# Actual detection.
output_dicts = run_inference_for_multiple_image(detect_images, detection_graph)
print("Detection finished")
# display result
for index, output in enumerate(output_dicts):
    ...
    plt.imshow(detect_images[index])
    plt.show()
